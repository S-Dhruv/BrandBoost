...
function App() {
  ...
  const ProtectedRoute1 = ({children}) =>{
    ...
    return isLogin === true && userType === "creator" ? children : <Navigate to="/creator/login" replace />
  }
  const ProtectedRoute2 = ({children}) =>{
    return isLogin === true && userType === "business" ? children : <Navigate to="/business/login" replace />
  }
  return (
    <>
    <Router>
      <Routes>
        ({userType === "creator"})?(
          ...
          <Route path="/business/dashboard" element={
            ...
            <Route path="/business/dashboard/jobs" element={
               <ProtectedRoute2>
                  <BusinessJobs />
               </ProtectedRoute2>
              } />
            <Route path="/business/dashboard/requests" element={
               <ProtectedRoute2>
                  <BusinessRequests />
               </ProtectedRoute2>
              } />
              <Route path="/business/dashboard/ongoing" element={
               <ProtectedRoute2>
                  <BusinessOngoing />
               </ProtectedRoute2>
              } />
              <Route path="/business/dashboard/post" element={
               <ProtectedRoute2>
                  <BusinessPosts />
               </ProtectedRoute2>
              } />

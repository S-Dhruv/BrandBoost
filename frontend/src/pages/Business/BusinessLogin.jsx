    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="bg-white/80 backdrop-blur-lg p-8 rounded-2xl shadow-2xl">
          <h2 className="text-3xl font-bold text-center text-[#CC5803] mb-8">Business Login</h2>
          ...
          <p className="mt-6 text-center text-gray-600">
            ...
            <a href="/business/signup" className="text-[#FF9505] hover:text-[#FFB627] font-medium transition-colors">
              Sign up
            </a>
          </p>
        </div>
